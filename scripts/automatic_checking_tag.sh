...
do 
    ...
    then
        ...
        then
            ...
            mkdir -p log
            qsub -v "MODEL_INDEX=$BASENAME,LISTEN_FOLDER=$LISTEN_FOLDER" -o "log/${MODEL_NAME}_${BASENAME}.log" -N "${MODEL_NAME}_${BASENAME}" scripts/convert_and_evaluate_complete_tag.sh
