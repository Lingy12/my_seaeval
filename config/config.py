...
DATASET_PATH = {
                ...
                'us_eval'       : 'all_data',
                'cn_eval'       : 'all_data',
                'flores_ind2eng': 'all_data',
                'flores_vie2eng': 'all_data',
                'flores_zho2eng': 'all_data',
                'flores_zsm2eng': 'all_data',
                'mmlu'          : 'all_data',
                'c_eval'        : 'all_data',
                'cmmlu'         : 'all_data',
                'zbench'        : 'all_data',
                'ind_emotion'   : 'all_data',
                'ocnli_mc'      : 'all_data',
                'c3_mc'         : 'all_data',
                'dream'         : 'all_data',
                'samsum'        : 'all_data',
...
DATASET_EVAL_SAMPLES = {
                            ...
                            'us_eval'       : 99999,
                            'cn_eval'       : 99999,
                            'flores_ind2eng': 99999,
                            'flores_vie2eng': 99999,
                            'flores_zho2eng': 99999,
                            'flores_zsm2eng': 99999,
                            'mmlu'          : 99999,
                            'c_eval'        : 99999,
                            'cmmlu'         : 99999,
                            'zbench'        : 99999,
...
DATASET_EVAL_SPLIT = {
                        ...
                        'us_eval'       : 'us_eval',
                        'cn_eval'       : 'cn_eval',
                        'flores_ind2eng': 'flores_ind2eng',
                        'flores_vie2eng': 'flores_vie2eng',
                        'flores_zho2eng': 'flores_zho2eng',
                        'flores_zsm2eng': 'flores_zsm2eng',
                        'mmlu'          : 'mmlu',
                        'c_eval'        : 'c_eval',
                        'cmmlu'         : 'cmmlu',
                        'zbench'        : 'zbench',
                        'ind_emotion'   : 'ind_emotion',
                        'ocnli_mc'      : 'ocnli_mc',
                        'c3_mc'         : 'c3_mc',
                        'dream'         : 'dream',
                        'samsum'        : 'samsum',
...
DATASET_TYPE = {
                    ...
                    'ocnli_mc'      : 'chi_ocnli_multi_choice',
                    'c3_mc'         : 'chi_c3_multi_choice',
                    'dream'         : 'eng_multi_choice_context',
                    'samsum'        : 'eng_summarization',
                    'dialogsum'     : 'eng_summarization',
                    'sst2_mc'       : 'eng_classification_multi_choice',
                    'cola_mc'       : 'eng_classification_multi_choice',
                    'qqp_mc'        : 'eng_classification_multi_choice',
                    'mnli_mc'       : 'eng_classification_multi_choice',
                    'qnli_mc'       : 'eng_classification_multi_choice',
                    'wnli_mc'       : 'eng_classification_multi_choice',
                    'rte_mc'        : 'eng_classification_multi_choice',
                    'mrpc_mc'       : 'eng_classification_multi_choice',
            }
